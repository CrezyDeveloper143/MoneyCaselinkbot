...
API_ID = int(os.getenv("API_ID", "5989342270"))
API_HASH = os.environ.get("API_HASH", "d67a800b4f2e182cf1430a1b0409a61a84024ace")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "6098282634:AAE_y7lPZRWDxTwUBRKShbMnWm4C5etj7HQ")
